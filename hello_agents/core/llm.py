...
import os
from typing import Literal, Optional, Iterator, List, Dict, Union, Any
from openai import OpenAI

from .exceptions import HelloAgentsException
from ..utils.env import get_config_section
...
class HelloAgentsLLM:
    ...
    def __init__(
            self,
            model: Optional[str] = 'qwen3.5-flash',
            api_key: Optional[str] = None,
            base_url: Optional[str] = None,
            provider: Optional[SUPPORTED_PROVIDERS] = 'custom',
        ...
        if model and api_key and base_url:
            ...
            default_llm = get_config_section(model)
